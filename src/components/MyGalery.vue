...
<template>
  <div>
    ...
    <label
      ...
      >Your Email</label
    >
    <div class="relative bottom-96   flex flex-col items-center     ">
      <!-- <div
 ...
 -->
      ...
      <div class="flex items-center">   
        ...
        <div class="relative w-full">
            ...
            <div>
            <input  v-model.lazy="username" size="60"   type="text" id="simple-search"   class="  divide-y divide-slate-200 md:text-3xl  bg-gray-100 border border-gray-300 text-gray-500 sm:text-sm  rounded-3xl focus:ring-blue-500 focus:border-blue-500 block pl-10 p-5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Busca imagenes creadas por Stable Diffusion" required="">
          </div>
          </div>



       <button   @click="fetchData" type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
